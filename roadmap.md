...
### Data 
- [ ] Integrate PerfumAPI
- [ ] Create fragrance import pipeline
- [ ] Build local fragrance dataset

## ⚠️ BELOW ARE FUTURE PHASES ⚠️

## Phase 2: Account creation, saved fragrances, UI improvement
...
- [ ] Continuation of the background slideshow concept, but now the vibes/notes/experiences will align with the interest the user has shown after arbitrary numbed of saved/owned fragrances
