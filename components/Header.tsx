...
export default function Header() {
    ...
    return (
        <header className="sticky top-0 z-50 flex justify-between items-center  bg-black/70 backdrop-blur-md border border-b border-white/10 cursor-pointer max-w-full p-6">
